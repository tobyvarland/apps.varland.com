...
class PermissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create permission" do
    assert_difference('Permission.count') do
      post permissions_url, params: { permission: { super_admin: @permission.super_admin, user_id: @permission.user_id } }
    end
  ...
  test "should update permission" do
    patch permission_url(@permission), params: { permission: { super_admin: @permission.super_admin, user_id: @permission.user_id } }
